...
Assurez-vous d'avoir Python version >= 3.8 < version 13 installé sur votre machine. Vous aurez également besoin des bibliothèques suivantes :

Make sure you have Python >= version 3.8 < version 13 installed on your machine. You will also need the following libraries:
